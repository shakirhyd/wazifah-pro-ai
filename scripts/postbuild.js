...
// 4. Ensure dist/client and dist are synced so both exist
if (targetDir === clientDir) {
  ...
  console.log('Synced dist/client files to dist root as fallback.');
} else {
  copyDirSync(distDir, clientDir);
  console.log('Synced dist files to dist/client.');
}
